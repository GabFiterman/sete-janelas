...
**Desenvolvedor Frontend / Full Stack (Pleno/Sênior)**

- 📍 Goiânia, GO | 📞 (62) 98460-2348 | ✉️ <gfiterman96@gmail.com>
- 🔗 setejanelas.com.br | github.com/gabfiterman | linkedin.com/in/gabfiterman

---

## Perfil Profissional

Desenvolvedor com mais de 5 anos de experiência no ecossistema JavaScript, atuando na intersecção entre Engenharia de Software e Design de Produto. Com background consolidado em UI/UX, sou especialista em eliminar gargalos de comunicação entre design e código, entregando interfaces complexas com fidelidade matemática ("Pixel Perfect") e foco extremo em performance. Engenheiro focado em produto (Product-Oriented), com autonomia para liderar frentes completas de desenvolvimento, desde a concepção do protótipo ao deploy.

---

## Proficiência Técnica (Stack)

- **Frontend Core:** JavaScript (ES6+), TypeScript, HTML5, CSS3 / SASS / Tailwind / Bootstrap.
- **Frameworks & State:** React (Context API, Redux, Zustand), Vue.js (Vue 2/3, Vuex, Pinia), Nuxt.js.
- **Mobile & Cross-Platform:** React Native, Expo, Quasar Framework.
- **Backend & Infra:** Node.js, Express, PHP, Java 8, Docker, REST APIs, WebSockets, WebServices.
- **Bancos de Dados:** PostgreSQL, MySQL, MongoDB, ElasticSearch.
- **Testes & Qualidade:** Jest, Vitest, Cypress, Clean Code, Clean Architecture, Atomic Design.
- **Ferramentas & Metodologias:** Vite, Webpack, Git/GitHub, CI/CD (Jenkins, AWS), Scrum / Kanban.
...
- **Evolução de Legado:** Desenvolvimento ponta a ponta em ambiente híbrido robusto (**PHP**, **JavaScript** e **PostgreSQL**), garantindo integridade de dados e retrocompatibilidade sem interrupção dos serviços.
...
- **Integração de Sistemas:** Responsável pela interface e consumo de APIs de serviços financeiros, garantindo consistência no fluxo de dados de checkout e liberação imediata de acessos.
...
- **Sistemas Escaláveis:** Contribuí no ecossistema utilizando **Vue/Nuxt.js**, **Node.js**, **ElasticSearch** e banco de dados **MongoDB**, com esteiras de CI/CD automatizadas via **Jenkins** e **Docker**.
...
- **Tecnólogo em Análise e Desenvolvimento de Sistemas** – Estácio (Graduação em 2023)
- **Inglês:** Conversacional / Avançado
